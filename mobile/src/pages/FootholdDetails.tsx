...
import kombi from '../images/k_verde.png'
import mapMarkerImg from '../images/marker04.png'


export default function FootholdDetails() {
    return (
        <ScrollView style={styles.container}>
            <View style={styles.imagesContainer}>
                <ScrollView horizontal pagingEnabled>
                    <Image style={styles.image} source={kombi} />
                    <Image style={styles.image} source={kombi} />
                    <Image style={styles.image} source={kombi} />
                </ScrollView>
            </View>
            ...
            <View style={styles.detailsContainer}>
                <Text style={styles.title}>Praia da Tainha</Text>
                <Text style={styles.description}>Praia da Tainha</Text>
